        ...
        <div class="info">
            <table class="table table-striped" >
                <thead style="background-color: #3274d6" align="center">
                    ...
                    <th>NO</th><th>NAMA PRODUK</th><th>DESKRIPSI</th><th>HARGA</th><th>FOTO PRODUK</th></th><th>AKSI</th>
                    </tr>
                </thead>
                <tbody align="center">
                    <?php
                    ...
                    ?>
                        ...
                        <td><img width="120" height="120" src="assets/foto_produk/<?=$data_produk['foto_produk']?>"></td>
            ...
            <td><a href="tambah_produk.php?id_produk=<?=$data_produk['id_produk']?>" class="btn btn-primary">Tambah Produk</a></td>
        </div>
    </div>
</div>
